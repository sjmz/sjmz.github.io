...
In practice it means that there are three additional bytes after between `b` and `c`.
...
This 'uninitialized stack data problem' is one of the key aspects of CVE-2014-3153, the bug that made Towelroot possible.
