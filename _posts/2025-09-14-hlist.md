...
This means that by placing a fictitious `struct 'TYPE'` structure at address '0', the address of any field coincide to the its displacement from the starting of the structure.
